...
HD_PWD='D:/ZYNQcode/PL/cymometer_top/cymometer_top.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cymometer_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cymometer_top.tcl -notrace
