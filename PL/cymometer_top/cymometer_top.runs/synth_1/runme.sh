...
HD_PWD='D:/ZYNQcode/PL/cymometer_top/cymometer_top.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cymometer_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cymometer_top.tcl
