...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../GPIO_EMIO.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../GPIO_EMIO.srcs/sources_1/bd/system/ipshared/70cf/hdl" \
       +incdir+"../../../../GPIO_EMIO.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../GPIO_EMIO.srcs/sources_1/bd/system/ipshared/70cf/hdl" \
       +incdir+"../../../../GPIO_EMIO.srcs/sources_1/bd/system/ip/system_processing_system7_0_0" \
